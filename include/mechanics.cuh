...
__device__ void computeForceDensityStates_GPU(long double *Tvector,
                                              ...
                                              long double *total_local_particle_damage_status_arr,     // size = localParticleSize
                                              ...
                                              long double *total_local_particle_current_positions_arr) // size = localParticleSize * ndim
{
    ...
    double* pj_local_current_positions = &total_local_particle_current_positions_arr[pj_local_idx * NDIM];
...
__global__ void compute_velocity_kernel_GPU(int ndim,
                                            ...
                                            long double *total_local_particle_volume_arr,       // size = localParticleSize
                                            double *total_local_particle_damage_status_arr,     // size = localParticleSize
    ...
    for (int cp_idx = 0; cp_idx < core_particle_size; ++cp_idx)
    {
        ...
        for (int cp_neighbor_idx = 0; cp_neighbor_idx < cp_neighbor_local_size; ++cp_neighbor_idx)
        {
            ...
            computeForceDensityStates_GPU<NDIM, STIFFNESS_TENSOR_SIZE, MAX_NEIGHBOR_CAPACITY>(
                ...
                total_local_particle_volume_arr,
                total_local_particle_damage_status_arr,
                total_local_particle_initial_positions_arr,
                total_local_particle_current_positions_arr);
...
// void compute_velocity_GPU(int rank,
//                           int ndim,
//                           double n1,
//                           double n2,
//                           double horizon,
...
//     long double *d_velocity_arr;
//     long double *d_acce_arr;
//     long double *d_net_force_arr;
//     int *d_particle_neighbor_sizes_arr;
//     int *d_particle_neighbors_arr;
//     int *d_local_particle_global_ids_arr;
//     int *d_global_to_local_ID_arr;
//     int *d_global_to_partition_ID_arr;
//     int *d_global_to_ghost_ID_arr;
//     double *d_bond_damage_arr;
//     long double *d_particle_volume_arr;
//     double *d_particle_damage_status_arr;
//     double *d_particle_initial_positions_arr;
//     double *d_particle_current_positions_arr;

//     // Global to local ID conversion
//     int *d_total_local_ID_arr;     // size = localParticleSize + ghostParticleSize
//     int *d_total_partition_ID_arr; // size = localParticleSize + ghostParticleSize
//     int *d_core_ID_arr;            // size = localParticleSize, local id is sorted
//     int *d_ghost_ID_arr;           // size = ghostParticleSize, local id is sorted

//     long double *d_local_veclocity_arr; // size = localParticleSize * ndim

//     // Use only local continuous IDs for local particles

//     // use another array identifying whether the particle is local or ghost
// }